...
public class SleepAveragesTest {
    ...
    private final DateTime expectedLatest;
    private final double delta = 0.05;

    @Parameters
    public static Collection<Object[]> createUrlUserData() throws Exception {
        
        SleepAverages set2 = new SleepAverages(asList(new SleepResource("2014-07-29 05:30 AM EST", 452, 40, 0),
                                                      ...
                                                      new SleepResource("2014-08-04 05:30 AM EST", 492, 26, 0)));
        
        return Arrays.asList(new Object[][]{
            {set2, 491, 93.74, SleepResource.DATE_TIME_FORMAT.parseDateTime("2014-08-04 05:30 AM EST")}
        });
    }

    public SleepAveragesTest(SleepAverages s, long total, double efficiency, DateTime latest) {
        averages = s;
        expectedTotal = total;
